...
["_main","_memory","___indirect_function_table","_fflush","___emscripten_embedded_file_data","onRuntimeInitialized"].forEach((prop) => {
...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'gs.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('gs.wasm', import.meta.url).href;
}
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 10329840;
